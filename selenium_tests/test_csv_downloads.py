...
def test_can_download_master_report_csv(browser, data_entry_clerk, initial_stones, download_file_dir):
    ...
    csv_file_content = (
        'id', 'basic_diamond_description', 'basic_grader_1', 'basic_grader_2', 'basic_grader_3', 'basic_carat', 'basic_color_1', 'basic_color_2', 'basic_color_3', 'basic_color_final', 'basic_clarity_1', 'basic_clarity_2', 'basic_clarity_3', 'basic_clarity_final', 'basic_fluorescence_1', 'basic_fluorescence_2', 'basic_fluorescence_3', 'basic_fluorescence_final', 'basic_culet_1', 'basic_culet_2', 'basic_culet_3', 'basic_culet_final', 'basic_culet_characteristic_1', 'basic_culet_characteristic_2', 'basic_culet_characteristic_3', 'basic_culet_characteristic_final', 'basic_girdle_condition_1', 'basic_girdle_condition_2', 'basic_girdle_condition_3', 'basic_girdle_condition_final', 'basic_polish_1', 'basic_polish_2', 'basic_polish_3', 'basic_polish_final', 'basic_girdle_min_grade_final', 'basic_remarks', 'diameter_min', 'diameter_max', 'height', 'table_size', 'crown_angle', 'pavilion_angle', 'star_length', 'lower_half', 'girdle_thickness_number', 'girdle_min_number', 'girdle_max_number', 'culet_size', 'crown_height', 'pavilion_depth', 'total_depth', 'table_size_rounded', 'crown_angle_rounded', 'pavilion_angle_rounded', 'star_length_rounded', 'lower_half_rounded', 'girdle_thickness_rounded', 'girdle_min_grade', 'girdle_max_grade', 'culet_size_description', 'crown_height_rounded', 'pavilion_depth_rounded', 'total_depth_rounded', 'sarine_cut_pre_polish_symmetry', 'sarine_symmetry', 'roundness', 'roundness_grade', 'table_size_dev', 'table_size_dev_grade', 'crown_angle_dev', 'crown_angle_dev_grade', 'pavilion_angle_dev', 'pavilion_angle_dev_grade', 'star_length_dev', 'star_length_dev_grade', 'lower_half_dev', 'lower_half_dev_grade', 'girdle_thick_dev', 'girdle_thick_dev_grade', 'crown_height_dev', 'crown_height_dev_grade', 'pavilion_depth_dev', 'pavilion_depth_dev_grade', 'misalignment', 'misalignment_grade', 'table_edge_var', 'table_edge_var_grade', 'table_off_center', 'table_off_center_grade', 'culet_off_center', 'culet_off_center_grade', 'table_off_culet', 'table_off_culet_grade', 'star_angle', 'star_angle_grade', 'upper_half_angle', 'upper_half_angle_grade', 'lower_half_angle', 'lower_half_angle_grade', 'date_from_gw', 'gw_return_reweight', 'gw_color', 'gw_clarity', 'gw_fluorescence', 'gw_remarks', 'gw_adjust_grader_1', 'gw_adjust_grader_2', 'gw_adjust_grader_3', 'gw_color_adjusted_1', 'gw_color_adjusted_2', 'gw_color_adjusted_3', 'gw_color_adjusted_final', 'gw_clarity_adjusted_1', 'gw_clarity_adjusted_2', 'gw_clarity_adjusted_3', 'gw_clarity_adjusted_final', 'gw_fluorescence_adjusted_1', 'gw_fluorescence_adjusted_2', 'gw_fluorescence_adjusted_3', 'gw_fluorescence_adjusted_final', 'gw_adjust_remarks', 'date_from_gia', 'gia_color', 'post_gia_final_color', 'gia_material_testing', 'gia_diamond_description', 'gia_remarks', 'gia_adjust_grader_1', 'gia_adjust_grader_2', 'gia_adjust_grader_3', 'gia_color_adjusted_1', 'gia_color_adjusted_2', 'gia_color_adjusted_3', 'gia_color_adjusted_final', 'gia_polish_adjusted_1', 'gia_polish_adjusted_2', 'gia_polish_adjusted_3', 'gia_polish_adjusted_final', 'gia_culet_adjusted_1', 'gia_culet_adjusted_2', 'gia_culet_adjusted_3', 'gia_culet_adjusted_final', 'gia_culet_characteristic_1', 'gia_culet_characteristic_2', 'gia_culet_characteristic_3', 'gia_culet_characteristic_final', 'gia_adjust_remarks', 'auto_table_size_rounded_grade', 'auto_crown_angle_rounded_grade_grade', 'auto_pavilion_angle_rounded_grade', 'auto_star_length_rounded_grade', 'auto_lower_half_rounded_grade', 'auto_girdle_thick_rounded_grade', 'auto_girdle_grade', 'auto_crown_height_rounded_grade', 'auto_total_depth_rounded_grade', 'auto_individual_cut_grade_grade', 'auto_est_table_cut_grade_grade', 'auto_gradia_cut_grade_grade', 'auto_final_sarine_cut_grade', 'auto_final_gradia_cut_grade', 'data_entry_user', 'split_from', 'gia_verification', 'gw_verification', 'remarks', 'internal_id', 'external_id'
    )
