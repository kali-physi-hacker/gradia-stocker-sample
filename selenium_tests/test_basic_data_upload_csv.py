...
def test_upload_fails_if_invalid_basic_inclusions_field(browser, data_entry_clerk, tanly, gary, kary, initial_stones):
...
def test_basic_data_upload_fails_if_invalid_data_type(browser, data_entry_clerk, tanly, gary, kary, initial_stones, inclusions):
