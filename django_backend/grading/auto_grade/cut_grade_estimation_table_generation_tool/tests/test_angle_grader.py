...
sys.path.append(".")
print(sys.path)
from ..core.angle_grader import DiamondAngleGrader


class DiamondAngleGraderTest(unittest.TestCase):
    def setUp(self):
        ...
        self.table_5 = DiamondAngleGrader(table_file_path=table_5_path)
        self.table_3 = DiamondAngleGrader(table_file_path=table_3_path)
    ...
    def test_table_raises_value_error_if_invalid_angles(self):
        ...
        with self.assertRaises(ValueError):
            self.table_3.get_grade(62.0, 38.8)
    ...
    def test_empty_table_raises_error(self):
        with self.assertRaises(Exception):
            ...
            self.table_1 = DiamondAngleGrader(table_file_path=table_1_path)
