    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sample_stone', models.CharField(blank=True, max_length=120, null=True)),
                ('shape_and_cutting', models.CharField(blank=True, max_length=120, null=True)),
                ...
                ('basic_polish_2', models.CharField(choices=[('EX', 'Excellent'), ('VG', 'Very Good'), ('GOOD', 'Good'), ('F', 'Fair'), ('P', 'Poor')], max_length=4, null=True)),
                ('basic_polish_3', models.CharField(choices=[('EX', 'Excellent'), ('VG', 'Very Good'), ('GOOD', 'Good'), ('F', 'Fair'), ('P', 'Poor')], max_length=4, null=True)),
                ('basic_final_polish', models.CharField(choices=[('EX', 'Excellent'), ('VG', 'Very Good'), ('GOOD', 'Good'), ('F', 'Fair'), ('P', 'Poor')], max_length=4)),
                ...
                ('girdle_min', models.CharField(choices=[('EXT', 'Extremely Thin'), ('VTN', 'Very Thin'), ('THIN', 'Thin'), ('MED', 'Medium'), ('STK', 'Slightly Thick'), ('THK', 'Thick'), ('VTK', 'Very Thick'), ('EXT', 'Extremely Thick'), ('F', 'Faceted'), ('SM', 'Smooth'), ('ETN TO VTN', 'Extremely thin - very thin')], max_length=10)),
                ('girdle_max', models.CharField(choices=[('EXT', 'Extremely Thin'), ('VTN', 'Very Thin'), ('THIN', 'Thin'), ('MED', 'Medium'), ('STK', 'Slightly Thick'), ('THK', 'Thick'), ('VTK', 'Very Thick'), ('EXT', 'Extremely Thick'), ('F', 'Faceted'), ('SM', 'Smooth'), ('ETN TO VTN', 'Extremely thin - very thin')], max_length=10)),
                ...
                ('cut_grade', models.CharField(blank=True, choices=[('EX', 'Excellent'), ('VG', 'Very Good'), ('GOOD', 'Good'), ('F', 'Fair'), ('P', 'Poor')], max_length=4, null=True)),
                ...
                ('grader_2', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='grader_2_for_stone', to=settings.AUTH_USER_MODEL)),
                ('grader_3', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='grader_3_for_stone', to=settings.AUTH_USER_MODEL)),
