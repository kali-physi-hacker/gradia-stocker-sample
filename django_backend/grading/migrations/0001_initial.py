    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('grader_2', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='grader_2_for_stone', to=settings.AUTH_USER_MODEL)),
                ('grader_3', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='grader_3_for_stone', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='SplitParcel',
